...
public class ClienteController {
    ...
    @Operation(summary = "Crear un cliente asociado a una tienda", description = "Crear un cliente asociandolo al id de una tienda que ya existe. Retorna un estado de http si se crea.")
